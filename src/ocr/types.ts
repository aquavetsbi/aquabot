...
export const productionDataSchema = z.object({
  ...
  report_type:     z.enum(['daily', 'weekly']).nullable().describe('Tipo de reporte: daily para diario o weekly para semanal'),
  week_end_date:   z.string().nullable().describe('Fecha de cierre de la semana en formato YYYY-MM-DD si el reporte es semanal'),
  ...
  sampling_weight_g: z.number().nullable().describe('Peso del muestreo en gramos si aparece separado del peso promedio'),
  ...
  biomass_kg:      z.number().nullable().describe('Biomasa total manual del estanque en kg. Si no aparece en la imagen, devuelve null'),
  ...
  confidence: z.object({
    ...
    report_type:     z.number().describe('Confianza de 0 a 100 para el tipo de reporte'),
    week_end_date:   z.number().describe('Confianza de 0 a 100 para la fecha de cierre semanal'),
    ...
    sampling_weight_g: z.number().describe('Confianza de 0 a 100 para peso de muestreo'),
    ...
    biomass_kg:      z.number().describe('Confianza de 0 a 100 para biomasa manual'),
